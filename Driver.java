...
public class Driver {
    public static void main(String[] args) throws IOException{
        // Define 5 edge-case polynomials
        ...
        Polynomial[] polys = {normal, constant, zero, negative, bigExp};
        String[] names = {"normal", "constant", "zero", "negative", "bigExp"};
    ...
    for (int i = 0; i < polys.length; i++) {
        ...
        System.out.println("normal at x=1: " + normal.evaluate(1));   // should be 6 - 2 + 5 = 9
        ...
        System.out.println("negative at x=2: " + negative.evaluate(2)); // should be -3 - 4 = -7
        ...
        System.out.println("zero poly has root 5? " + zero.hasRoot(5)); // tricky: 0 == 0 → true
    
        // Test SaveToFile + File Constructor
        // =====================
        for (int i = 0; i < polys.length; i++) {
